...
#
setwd("C:\WAREHOUSE\Statistics for Data Analytics\Linear, Multilinear Regression") 
...
###          Checking mean, median, stand.deviation, variance, skew, min , max range plus data visualization of each independent variable with histogram and boxplot.  
##
#
...
###          Looking for correlation between CRIME and each independent variable. 
##
#
...
###          Looking for strongest correlation between CRIME and independent variables at once. 
##
#    
...
##
###
#### Part e) Non-linear association - Polynomial regression 
###
##
#  
      # 1. ZN
